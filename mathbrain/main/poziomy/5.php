...
<div id="srodek">
    ...
    if(isset($_SESSION['nazwa'])){
        if ($twojPoziom > $poziom) {
            echo '<button class="submit" id="potwierdz" onclick="sprawdzOdpBez5()">ALL DONE</button>';
            exit(); 
    }else{
        echo '<button class="submit" id="potwierdz" onclick="sprawdzOdp5()">ALL DONE</button>';
    }
}
else{
    echo '<button class="submit" id="potwierdz" onclick="sprawdzOdpBez5()">ALL DONE</button>';
